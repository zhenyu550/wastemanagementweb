                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 mb-5">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="h6 text-uppercase mb-0">View Staffs</h3>
                                </div>
                                <div class="card-body">
                                    <form class="form-horizontal" action="viewstaffs_post.php" method="post">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <select class="form-control" name="search_by">
                                                            ...
                                                            $option_names = array("Staff Name", "Branch Name", "Staff Type", "Username");
                                                            $option_values = array("name", "branch", "type", "username");
                        ...
                        <div class="col-lg-12 mb-4" style="margin: auto">
                            <div class="card">
                                <div class="card-header">
                                    <form>
                                        <button id="button-add" type="submit" name="add" class="btn btn-primary" formaction="addstaff.php" formmethod="post">Add Staff</button>
                                    </form>
                                    <h6 class="text-uppercase mb-0" style="text-align: center;">List of Staffs</h6>
                                    <!-- Modal Form-->
                                    <div class="card-body">
                                        <table class="table table-striped table-hover card-text" id="transaction_table">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($items as $item) {
                                                    ...
                                                    echo "<td>" . $item->get_type() . "</td>";

                                                    $branch_id = $item->get_cp_id();
                                                    $branch = Collection_Point::find("id=" . $branch_id);
                                                    echo "<td>" . $branch->get_name() . "</td>";

                                                    echo "<td>" . $item->get_name() . "</td>";
                                                    echo "<td>" . $item->get_contact_no() . "</td>";
                                                    echo "<td>" . $item->get_email() . "</td>";
                                                    echo "<td>" . $item->get_staff_username() . "</td>";


                                                    echo "<form>";
                                                    echo "<td><button type='submit' class='btn btn-primary' name='edit' formmethod='post' formaction='editstaff.php'>Edit</button></td>";
                                                    // echo "<td><button type='submit' class='btn btn-primary' name='delete' formmethod='post'>Delete</button></td>";
                                                    echo "<input type='hidden' name='staff_id' value='$item_id'>";
                                                    echo "</form>";
                                                    echo "</tr>";
                                                }
                                                ?>
