  ...
  <div class="page-holder d-flex align-items-center">
    <div class="container">
          ...
          <form id="loginForm" action="login_post.php" method="post" class="mt-4">
            <div class="form-group mb-4">
              ...
              if (isset($_SESSION["username"])) {
                ...
                echo "<input type=\"text\" name=\"username\" placeholder=\"Staff Username\" class=\"form-control border-0 shadow form-control-lg\" value=$username />";
              } else {
                echo "<input type=\"text\" name=\"username\" placeholder=\"Staff Username\" class=\"form-control border-0 shadow form-control-lg\" />";
              }
              ?>
            </div>
            <div class="form-group mb-4">
      ...
      <p class="mt-5 mb-0 text-gray-400 text-center">
        Design by
        <a href="https://bootstrapious.com/admin-templates" class="external text-gray-400">Bootstrapious</a>
        & Your company
      </p>
