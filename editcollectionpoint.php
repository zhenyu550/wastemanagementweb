                                ...
                                <div class="card-body">
                                    <form class="form-horizontal">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" placeholder="Insert branch name" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" placeholder="Insert phone no" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-md-2 form-control-label">Fax No.</label>
                                            <div class="col-md-9">
                                                <input type="text" placeholder="Insert fax no."
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" placeholder="Insert city" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row">
